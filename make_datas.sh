# NOTE: this assumes that the discogs-vi-2 repo is in the same parent directory as this repo.
...
cp "${dvi2_path}train.json" "${dvi2_path}test.json" "${dvi2_path}valid.json" data/dvi2/

# Copy matched/train.json, matched/test.json, matched/val.json to data/dvi2fm
cp "${dvi2_path}matched/train.json" "${dvi2_path}matched/test.json" "${dvi2_path}matched/valid.json" data/dvi2fm/
...
cp "${dvi2_path}valid.json" data/dvi2fm_light/
